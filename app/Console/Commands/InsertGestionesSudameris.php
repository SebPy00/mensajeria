...
class InsertGestionesSudameris extends Command
{
     ...
     * @var string
     */
    protected $signature = 'gestiones:sudameris';
    ...
    private function getGestiones($fecha){
        ...
        $fechaDesde = '2024-01-03 00:00:00'; //Usar para tener gestiones de dias anteriores
        $fechaHasta = '2024-01-03 23:59:59'; //Usar para tener gestiones de dias anteriores
