...
class InsertGestionesCPH extends Command
{
    ...
    private function getGestiones($fecha){
        ...
        //$fechaDesde = '2024-01-11 00:00:00'; //Usar para tener gestiones de dias anteriores
        //$fechaHasta = '2024-01-11 23:59:59'; //Usar para tener gestiones de dias anteriores
